...
@Component({
  selector: 'app-seeker-update-pro',
  templateUrl: './seeker-update-pro.component.html',
  styleUrls: ['./seeker-update-pro.component.scss']
})
export class SeekerUpdateProComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.profileForm = new FormGroup({
      ...
      contactNo: new FormControl('',[Validators.required,Validators.pattern('^(\\+88|0088)?0{1}1{1}[0-9]{9}$')]),
  ...
  onSubmit() {
   ...
   console.log(this.profileForm.value+"---------seeker pro: ----------");
