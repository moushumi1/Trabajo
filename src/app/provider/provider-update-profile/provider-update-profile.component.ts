...
@Component({
  selector: 'app-provider-update-profile',
  templateUrl: './provider-update-profile.component.html',
  styleUrls: ['./provider-update-profile.component.scss']
})
export class ProviderUpdateProfileComponent implements OnInit {
  ...
  ngOnInit() {
   ...
   // this.oldInfo=this.userSer.collectInfo();
    //console.log('userInfo'+this.oldInfo);
  ...
  onSubmit() {
   ...
   return;	
    ...
    console.log(this.profileForm.value+"---------88----------");
